...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/voeventlib-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/voeventlib-feedstock)
...
Once the `conda-forge` channel has been enabled, `voeventlib` can be installed with:

```
conda install voeventlib
```

It is possible to list all of the versions of `voeventlib` available on your platform with:
